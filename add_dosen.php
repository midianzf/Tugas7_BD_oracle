            ...
            <form method="POST" action="input_dosen.php" >
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" name="NIP" class="form-control" id="#" placeholder="Enter NIP " value="">
                </div>
                <div class="form-group">
                  <label for="jk">Nama Dosen</label>
                  <input type="text" name="NAMA_DOS" class="form-control" id="#" placeholder="Nama dosen">
                </div>
                <div class="form-group">
                  <label for="alamat">Telepon</label>
                  <input type="text" name="TELP" class="form-control" id="#" placeholder="Telp">
                </div>
                 <div class="form-group">
