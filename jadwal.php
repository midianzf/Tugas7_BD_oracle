        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
             ...
             <div class='panel-body'>
                <a class='btn btn-primary' href='add_jadwal.php'><i class='fa fa-plus'></i> Tambah Data</a>
          ...
          while (($d = oci_fetch_array ($stid, OCI_BOTH)) != false) {
            ...
            <tr>
              ...
              <td><?= $d['HARI']; ?></td>  
              <td class="td-actions">
              <a class='btn btn-success' href="edit_jadwal.php?ID_JADWAL=<?= $d["ID_JADWAL"];?>" 
              ><i class='fa fa-edit'></i></a>
              <a class='btn btn-danger' onclick="return confirm('Anda yakin ingin menghapus data tersebut?');" 
              href="hapus_jadwal.php?ID_JADWAL=<?= $d["ID_JADWAL"];?>" 
