  ...
  <div class="content-wrapper">
    ...
    <section class="content">
     ...
     <?php
      ...
      $stid = oci_parse($koneksi, "SELECT * FROM ADMIN WHERE ID_ADMIN='$ID_ADMIN'");
      oci_execute($stid);
            ...
            <form method="POST" action="update_admin.php" enctype="multipart/form-data" >
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="nama" name="NAMA_ADMIN" class="form-control" id="#" placeholder="Enter nama jenis kelapa" value="<?= $d['NAMA_ADMIN']; ?>">
                </div>
                <div class="form-group">
                  <label for="harga">Jenis Kelamin</label>
                  <input type="alamat" name="JK_ADMIN" class="form-control" id="#" placeholder="Harga" value="<?= $d['JK_ADMIN']; ?>">
                </div>
                  <div class="form-group">
                  <label for="harga">Alamat</label>
                  <input type="alamat" name="ALAMAT_ADMIN" class="form-control" id="#" placeholder="Harga" value="<?= $d['ALAMAT_ADMIN']; ?>">
                </div>
                  <div class="form-group">
