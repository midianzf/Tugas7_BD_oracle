    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
             ...
             <div class='panel-body'>
                <a class='btn btn-primary' href='add_ruang.php'><i class='fa fa-plus'></i> Tambah Data</a>
          ...
          $stid = oci_parse($koneksi, 'SELECT * from ruang');
          ...
          while (($d = oci_fetch_array ($stid, OCI_BOTH)) != false) {
            ...
            <tr>
              ...
              <td><?= $d['FAKULTAS']; ?></td>  
              <td class="td-actions">
              <a class='btn btn-success' href="edit_ruang.php?NO_RUANG=<?= $d["NO_RUANG"];?>" 
              ><i class='fa fa-edit'></i></a>
              <a class='btn btn-danger' onclick="return confirm('Anda yakin ingin menghapus data tersebut?');" 
              href="hapus_ruang.php?NO_RUANG=<?= $d["NO_RUANG"];?>" 
