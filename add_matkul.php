            ...
            <form method="POST" action="input_matkul.php" >
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" name="NAMA_MK" class="form-control" id="#" placeholder="Enter nama " value="">
                </div>
                <div class="form-group">
                  <label for="jk">SKS</label>
                  <input type="text" name="SKS" class="form-control" id="#" placeholder="SKS">
                </div>
                <div class="form-group">
                  <label for="alamat">Semester</label>
                  <input type="text" name="SEMESTER" class="form-control" id="#" placeholder="Semester">
                </div>
